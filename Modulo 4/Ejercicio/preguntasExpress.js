...
if (req.query.num_pregunta === '1')  {
				...
				if(resul === "colon" || resul === "cristobal colon") {
						resul
					text += '<p>Genial!!!, ha contestado correctamente.</p>';
				
				} else { text +='<p>Ha fallado!!, la respuesta correcta es Cristóbal Colón</p>.';}
			}else{
				...
				if(resul === "lisboa") {
					...
					text = text + '<p>Genial!!!, ha contestado correctamente.</p>';

			    } else { text +='<p>Ha fallado!!, la respuesta correcta es Lisboa.</p>';}
			}
